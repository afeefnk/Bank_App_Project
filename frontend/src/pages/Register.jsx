...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3005/api/users/register", formData, {
        headers: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <ToastContainer />
      <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-lg max-w-3xl w-full h-auto md:h-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 px-4 md:grid-cols-2 gap-x-7">
                ...
                <div className="md:col-span-2 mt-5 mb-3 flex items-center">
                  ...
                  >
                    <FaUpload className="mr-2 text-xl text-black" />
